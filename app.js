...
function renderRecurrings(){
  ...
  const recurringTotals=`<div class="recurring-total-cards" aria-label="Resumen de pagos recurrentes"><div><span>Total recurrentes</span><strong>${money(totalRecurring)}</strong></div><div class="pending"><span>No completados</span><strong>${money(totalPending)}</strong></div></div>`;
